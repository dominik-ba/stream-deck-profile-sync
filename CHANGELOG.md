...
- `--diff` option on the `status` command.  When provided, a unified diff of
  each modified file's content is printed directly below the file path, making
  it easy to see exactly what changed without leaving the terminal.  Binary
  files are detected automatically and reported as `(binary file)` instead of
...
- [Unreleased](https://github.com/dominik-ba/stream-deck-profile-sync/compare/0.3.0...HEAD)
- [0.3.0](https://github.com/dominik-ba/stream-deck-profile-sync/compare/0.2.0...0.3.0)
- [0.2.0](https://github.com/dominik-ba/stream-deck-profile-sync/compare/0.1.0...0.2.0)
- [0.1.0](https://github.com/dominik-ba/stream-deck-profile-sync/releases/tag/0.1.0)
